...
<template>
  <SubmitForm :isSubmitWaiting="false" submitResultMsg="" btnMsg="다음" :enableBtn="enableNextBtn" @on-submit="onSubmitTermAgree">
    ...
    <template v-slot:content>
      ...
      5. 서비스 이용
      사이트는 회원에게 다양한 온라인 토론 및 커뮤니케이션 서비스를 제공합니다.
      사이트는 서비스 개선을 위해 예고 없이 서비스를 변경할 수 있습니다.
      ...
      8. 면책 조항
      사이트는 천재지변, 전쟁, 테러 등 불가항력적 사건으로 인한 서비스 중단에 대해 책임지지 않습니다.
...
1. 개인정보의 수집 및 이용 목적
'모두의토론'은 회원가입, 다양한 서비스 제공을 위해 최소한의 개인정보를 수집하고 있습니다. 수집하는 개인정보 항목은 다음과 같습니다.

필수항목: 이메일 주소

2. 개인정보의 처리 및 보유 기간
회원 정보는 매일 00시에 일괄 삭제 됩니다.

3. 개인정보의 제3자 제공
'모두의토론'은 원칙적으로 사용자의 동의 없이 개인정보를 외부에 제공하지 않습니다. 다만, 법적인 요구가 있는 경우나 서비스 제공에 필수적인 경우에 한하여 제한적으로 정보를 공유할 수 있습니다.
...
5. 권리 및 의무 안내
회원은 언제든지 자신의 개인정보를 조회하거나 수정할 수 있으며, 회원 탈퇴를 요청할 수도 있습니다.
